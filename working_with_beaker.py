...
def main(args: argparse.Namespace):
    ...
    image = f"anli/adv-filtering:{commit}"
    ...
    cmd = f'./anli/adversarial_filtering/AF_iterations.sh {args.input} {args.pos} {args.neg} {args.mode}'
...
if __name__ == "__main__":
    ...
    parser.add_argument('--input',
                        type=str,
                        default='/data/anli_valid_all_train_parts0-4_uniquekeys.jsonl',
                        help="Input file for the 1st iteration of AF")
    parser.add_argument('--pos',
                        type=str,
                        default='/data/anli_valid_all_train_parts0-4.jsonl',
                        help='File containing the positive middles to pick from.'
                        )
    parser.add_argument('--neg',
                        type=str,
                        default='/data/anli_valid_all_train_parts0-4.jsonl',
                        help='File containing the negative middles to pick from.'
                        )
    parser.add_argument('--mode',
                        type=str,
                        default=AFMode.MOST_CONFUSING)
