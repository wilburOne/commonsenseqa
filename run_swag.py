...
def main():
    ...
    parser.add_argument("--data_dir",
                        default="/data/m1/huangl7/CommonsenseQaPlus/data/swag/",
                        type=str,
    ...
    parser.add_argument("--output_dir",
                        default="/data/m1/huangl7/CommonsenseQaPlus/data/swag/output2/",
                        type=str,
    ...
    if args.do_train:
        ...
        for _ in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            print("current train accuracy ... " + str(train_acc))
    ...
    if args.do_eval and (args.local_rank == -1 or torch.distributed.get_rank() == 0):
        ...
        print("eval_accuracy " + str(eval_accuracy))
