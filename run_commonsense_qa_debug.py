...
class CommonsenseQaProcessor(DataProcessor):
    ...
    def _create_examples(self, records, set_type):
        ...
        for (i, record) in enumerate(records):
            ...
            option_context = context + " " + question

            examples.append(
                InputExampleWithListFourFields(guid=guid,
                                               text_a=[option_context, option_context, option_context, option_context],
                                               text_b=[answer1, answer2, answer3, answer4],
                                               text_c=None,
                                               text_d=None,
                                               label=label
                                               )
...
def convert_examples_to_features_mc(examples, label_list, max_seq_length, tokenizer):
    ...
    print("label list: " + str(label_map))
