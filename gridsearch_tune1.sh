...
do
    ...
    do
        ...
        for e in "${epochs[@]}"
        do
            python run_commonsense_qa_debug1.py --task_name "${task}" --do_eval --do_train --bert_model bert-base-uncased --data_dir /data/m1/huangl7/CommonsenseQaPlus/baselines/data/ --max_seq_length 128 --train_batch_size ${s} --learning_rate ${l} --num_train_epochs ${e} --output_dir /data/m1/huangl7/CommonsenseQaPlus/baselines/pytorch_pretrained_bert/output1/batch_${s}_lr_${l}_epochs${e}
